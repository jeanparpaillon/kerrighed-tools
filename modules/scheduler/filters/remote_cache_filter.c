/*
 *  Kerrighed/modules/scheduler/filters/remote_cache_filter.c
 *
...
#include <scheduler/core/filter.h>
...
/* 	.SCHEDULER_FILTER_SOURCE_PARAM_TYPE(remote_cache_filter, unsigned int), */
