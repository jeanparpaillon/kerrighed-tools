/*
 *  Kerrighed/modules/scheduler/probes/mosix_probe.c
 *
...
#include <scheduler/core/probe.h>
...
#define to_mosix_probe_info(sched_info) \
	container_of((sched_info), struct mosix_probe_info, module_info)
