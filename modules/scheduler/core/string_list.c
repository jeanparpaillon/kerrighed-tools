/*
 *  Kerrighed/modules/scheduler/core/string_list.c
 *
...
static struct string_list_element * string_list_find_element(
	struct string_list_object *object,
	const char *element)
{
	struct string_list_element *elt;
...
{
	string_list_cachep =
		kmem_cache_create("string_list_kddm_obj",
				  sizeof(struct string_list_object),
				  0, SLAB_PANIC,
				  NULL, NULL);
